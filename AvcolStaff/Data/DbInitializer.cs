    ...
    public class DbInitializer
    {
        public static void Initialize(AvcolStaffContext context)
        {
            ...
            var staffs = new Staff[]
            {
                ...
                new Staff{FirstName="Grace",LastName="Williams",TeacherCode="",HireDate=DateTime.Parse("2017-09-01")},
                new Staff{FirstName="Yasmin",LastName="Khan",HireDate=DateTime.Parse("2017-09-01")},
                new Staff{FirstName="Emma",LastName="Watt",TeacherCode="",HireDate=DateTime.Parse("2017-10-01")},
                new Staff{FirstName="Jaqui",LastName="Brikhead",TeacherCode="",HireDate=DateTime.Parse("2017-09-01")},
